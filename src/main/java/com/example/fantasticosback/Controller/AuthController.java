...
public class AuthController {
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest loginRequest) {
        try {
            ...
            User user = matcherService.obtenerUsuario(loginRequest.getEmail());

            LoginResponse response = new LoginResponse(perfil, user.getRol());
    ...
    public ResponseEntity<?> register(@RequestBody RegisterRequestDTO registerRequest) {
        ...
        User guardado = userRepository.save(nuevoUser);

        UserResponseDTO response = new UserResponseDTO(
                guardado.getEmail(),
                guardado.getRol(),
                guardado.getProfileId()
        );
